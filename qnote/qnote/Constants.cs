...
namespace qnote
{
    ...
    class Constants
    {
        ...
        public static string PATH = @"profiles.txt";
        public static string statusPATH = @"status.txt";
        ...
        public static Bitmap fav = new Bitmap(@"img\fav.png");
        public static Bitmap unfav = new Bitmap(@"img\unfav.png");
        public static Bitmap fav_line = new Bitmap(@"img\fav_line.png");
        public static Bitmap unfav_line = new Bitmap(@"img\unfav_line.png");
        public static Bitmap delete = new Bitmap(@"img\delete.png");
